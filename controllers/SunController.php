...
use app\models\forms\SunForm;
use app\models\observations\Sun;
use Yii;
...
class SunController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel->type = Observe::TYPE_SUN;
     ...
     * @param integer $id
     * @return Sun the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Sun::findOne($id)) !== null) {
            return $model;
        }
